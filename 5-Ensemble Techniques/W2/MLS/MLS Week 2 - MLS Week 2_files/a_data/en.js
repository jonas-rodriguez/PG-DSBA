window.messages = {
    ...
    "AskQuestionFromUser": "Ask question from {user}",
    ...
    "Currency.GeneralSettings": "General Settings",
    "Currency.InternalName": "Internal currency name",
    "Currency.Redeem Description": "Redeem Description",
    ...
    "Email.UnsubscribeDescription": "<a href=\"{link}\">Unsubscribe and Manage Emails</a>",
    ...
    "NoMembers": "This {groupSingularName} has no members",
    ...
    "Portal.OriginallyPostedInPortal": "Originally posted in {portal}",
    ...
    "Post.PostIsCollapsed": "This post is collapsed because of its low quality.",
    ...
    "Question.PleaseReadQuestionRules": "Please read question guidelines before asking a question.",
    "Question.Poll": "Poll",
    ...
    "RegisterWithSlack": "Register with Slack",
    ...
    "Report.Harrasment": "Harrasment",
    "Report.HarrasmentDescription": "Disparaging or adversarial towards a person or {group}",
    ...
    "Reputation.GeneralSettings": "General Settings",
    ...
    "Topic.ChildTopics": "Child Topics",
    ...
    "Transaction.NameWithdrewAmountCreditFromYou": "{name} withdrew {amount} {currencyName} from you.",
    "Transaction.NoTransactions": "No transactions yet.",
    "Transaction.YouHaveDepositedAmountCreditToName": "You have deposited {amount} {currencyName} to {name}.",
    "Transaction.YouHaveReceivedAmountCredit": "You have received {amount} {currencyName} from {name}.",
    "Transaction.YouWithrewAmountCreditFromUser": "You withdrew {amount} {currencyName} from {name}.",
    ...
    "User.YouCannotChangeTheRoleOfYourself": "You cannot change the role of yourself.",
    ...
    "Currency.EnableStoreLabel": "By enabling this option users can spend their virtual money in the store",
    ...
    "Reputation.Exclude Admins": "Exclude admins, moderators, and bots from leaderboard",
    "Transaction.YouRedeemedAmount": "You have redeemed {amount} {currencyName}.",
    ...
    "Sort.LastActivit": "Recent Activity",
    ...
    "Error.OneAdminRequired": "There must be at least 1 admin in the community.",
    "App.JWT.ShowTribeAuth": "Enable JWT alongside Tribe authentication",
    "App.JWT.ShowTribeAuthTooltip": "We show a button in login and register pages where user can use your JWT authentication",
    "Telegram.RequestIsInvalid": "Something went wrong, please retry.",
    "Notification.UserUpdatedAnswer": "{user} updated answer {title}.",
    "Portal.Notifications": "Email Notifications",
    "YourCreditTitle": "Your {name}"
}