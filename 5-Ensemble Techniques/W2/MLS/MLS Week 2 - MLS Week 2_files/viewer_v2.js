...
function webViewerKeyDown(evt) {
  // overrided by Manjari (to only execute for files page)
  if (PDFViewerApplication.overlayManager.active || !window.location.href.includes('/files/')) {
    return;
  }
